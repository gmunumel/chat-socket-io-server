...
_ava2.default.cb('a socket can emit to a room', t => {
  const server = new _mockSocket.Server('ws://roomy');
  const socketFoo = (0, _mockSocket.SocketIO)('ws://roomy');
  const socketBar = (0, _mockSocket.SocketIO)('ws://roomy');
  const redisMock = _redisMock.redis.createClient();
...
//# sourceMappingURL=../node_modules/.cache/ava/7f6a55777bd3c19f2456c422eebaf1f0.js.map